 ...
 *
 * @providesModule NavigatorIOSXXX
 * @flow
 */
'use strict';
...
var NavigatorIOS = React.createClass({
  ...
  _renderNavigationStackItems: function() {
    ...
    // XXX the hack is here, we always propate the
    // redraw to the children
    ...
    var items = this.state.routeStack.map(this._routeToStackItem)
    return (
